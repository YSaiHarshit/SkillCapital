...
export default function Courses() {
    ...
    return (
        ...
        <div>
            ...
            <div className="bg-red-100 mt-22 p-6 flex justify-center">
                <h2 className="text-3xl text-red-500 font-normal">All Courses</h2>
                <div className="flex items-center justify-center">
                    <div className="w-px h-10 bg-pink-500 ml-4"></div>
                </div>
                <div className="flex items-center justify-center px-4 py-2">
                    <h2>Find and select your desired course below.</h2>
                </div>
            </div>
